...
#IMPORTANT: Need to convert to 50 pixels height for template matching
r = 50.0 / template.shape[0]
dim = (int(template.shape[1] * r), 50)
...
for imagePath in glob.glob(args["images"] + "/*.jpg"):
	...
	#Scale image to 1500 pixel width
